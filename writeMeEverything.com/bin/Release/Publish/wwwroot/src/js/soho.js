...
$(function () {
    ...
    $(document).ready(function () {
        Soho.Started.scrolllRun();
        Soho.Started.init();
    });

    $(window).on('resize', function () {
        Soho.Started.mobileBrowserVhProblemFixed();
    });
    ...
    $(document).on('click', '[data-navigation-target]', function () {
        var target = $(this).data('navigation-target'),
            sidebar = $('.sidebar-group .sidebar#' + target);

        sidebar.closest('.sidebar-group').find('.sidebar').removeClass('active');
        sidebar.addClass('active');
        sidebar.find('form input:first').focus();

        $('[data-navigation-target]').removeClass('active');
        $('[data-navigation-target="' + target + '"]').addClass('active');

        if (jQuery.browser.mobile) {
            $('.sidebar-group').removeClass('mobile-open');
            sidebar.closest('.sidebar-group').addClass('mobile-open');
        }

        Soho.Started.scrolllRun(true);
